...
/*   Updated: 2023/07/07 16:36:24 by abelhadj         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	nbr_init2(void)
{
	...
	g_data.nbr[10].img = mlx_xpm_file_to_image(g_data.mlx, "file/bar.xpm",
			&x, &x);
	if (!g_data.nbr[5].img || !g_data.nbr[6].img || !g_data.nbr[7].img
		|| !g_data.nbr[8].img || !g_data.nbr[9].img || !g_data.nbr[10].img)
		return (1);
	return (0);
}
...
int	nbr_init(void)
{
	...
	g_data.nbr[4].img = mlx_xpm_file_to_image(g_data.mlx, "file/4.xpm",
			&x, &x);
	if (!g_data.nbr[0].img || !g_data.nbr[1].img || !g_data.nbr[2].img
		|| !g_data.nbr[3].img || !g_data.nbr[4].img || nbr_init2())
		return (1);
	return (0);
}
...
int	gun_init(void)
{
	...
	if (!g_data.gun[0].img || !g_data.gun[1].img || !g_data.gun[2].img
		|| !g_data.gun[3].img || !g_data.gun[4].img || !g_data.gun[5].img)
		return (1);
	return (0);
}
...
int	wall_init(void)
{
	...
	if (!g_data.no.img || !g_data.so.img || !g_data.ea.img || !g_data.we.img)
		return (1);
